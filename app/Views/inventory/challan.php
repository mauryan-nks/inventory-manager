...
<section class="challan-copy"><div class="challan-inner">
...
.sheet{width:210mm;height:297mm;margin:18px auto;background:#fff;padding:4mm;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 8px 35px rgba(15,23,42,.14)}
.challan-copy{height:135mm;flex:0 0 135mm;padding:2.5mm 3.5mm;border:1px solid #bfc6d0;overflow:hidden;break-inside:avoid;page-break-inside:avoid;position:relative}
...
.challan-header{display:flex;justify-content:space-between;align-items:flex-start;gap:8px;border-bottom:1.5px solid #18202a;padding-bottom:4px}
...
.challan-title{text-align:center;font-size:13px;font-weight:800;letter-spacing:1.5px;margin:4px 0}
...
@media print{
  ...
  .sheet{width:210mm;height:297mm;margin:0;padding:4mm;box-shadow:none;overflow:hidden}
  .challan-copy{height:135mm;flex:0 0 135mm;overflow:hidden}
  .cut-line{height:7mm;flex:0 0 7mm}
}
</style>
</head>
<body>
...
(function(){
  function fitChallans(){
    document.querySelectorAll('.challan-copy').forEach(function(copy){
      ...
      if(needed>available){
        var scale=Math.max(0.55, available/needed);
