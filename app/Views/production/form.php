...
<div class="page-head"><div><div class="page-kicker">Factory</div><h1 class="page-title">Add Factory Production</h1><p class="page-subtitle">Keep production entry simple: date, item, category and quantity.</p></div><div class="head-actions"><a class="btn" href="<?=site_url('production')?>">← Production</a></div></div>
